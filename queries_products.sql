-- Add a product to the table with the name of “chair”, price of 44.00, and can_be_returned of
-- false.
...
-- Add a product to the table with the name of “table”, price of 124.00, and can_be_returned of
-- false.
INSERT INTO products (name, price, can_be_returned) VALUES
    ('table', 124.00, 'f')
;
...
-- Because of the sale, everything that costs less than $25 has sold out. Remove all products whose
-- price meets this criteria.
